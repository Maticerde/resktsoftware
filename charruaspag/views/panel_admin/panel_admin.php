...
<section id="grid-mod-functions">
  ...
  <section id="grid-functions">
    ...
    <div class="box" id="adduser-box">
      ...
      <span id="mensaje"></span>
      <form action="/controllers/Register_Controller.php" method="POST" id="adduser-form">
        <section id="input_grid">
        <label class="input_label">
    ...
    <div class="box" id="addadmin-box">
      ...
      <span id="mensaje"></span>
      <form action="/controllers/Register_Controller.php" method="POST" id="addadmin-form">
        <section id="input_grid">
        <label class="input_label">
